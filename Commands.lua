...
local function HandleSlashCommand(msg)
    ...
    if not cmd or cmd == "" or cmd == "help" then
        ...
        TerrorSquadAI:Print("/tsa config - Abrir configuraci\195\179n")
        ...
        TerrorSquadAI:Print("/tsa tactic <nombre> - Activar t\195\161ctica")
        TerrorSquadAI:Print("")
        TerrorSquadAI:Print("|cFFFFFF00--- v3.0 Nuevos ---|r")
        TerrorSquadAI:Print("/tsa score - Estad\195\173sticas PvP")
    ...
    if cmd == "config" or cmd == "options" or cmd == "menu" then
        if TerrorSquadAI.Modules.Config then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo Config no disponible")
        end
        return
    end
    ...
    if cmd == "radar" then
        if TerrorSquadAI.Modules.TacticalRadar then
            TerrorSquadAI.Modules.TacticalRadar:Toggle()
        else
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo TacticalRadar no disponible")
        end
        return
    end
    ...
    if cmd == "hud" then
        if TerrorSquadAI.Modules.TacticalHUD then
            TerrorSquadAI.Modules.TacticalHUD:Toggle()
        else
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo TacticalHUD no disponible")
        end
        return
    end
    
    -- Board
    if cmd == "board" or cmd == "pizarra" then
        if TerrorSquadAI.Modules.TerrorBoard then
            TerrorSquadAI.Modules.TerrorBoard:Toggle()
        else
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo TerrorBoard no disponible")
        end
        return
    end
    ...
    if cmd == "score" or cmd == "pvp" then
        if TerrorSquadAI.Modules.PvPScorecard then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo PvPScorecard no disponible")
        end
        return
    end
    ...
    if cmd == "buffs" or cmd == "buff" then
        if TerrorSquadAI.Modules.BuffMonitor then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo BuffMonitor no disponible")
        end
        return
    end
    ...
    if cmd == "wipe" then
        if TerrorSquadAI.Modules.WipePredictor then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo WipePredictor no disponible")
        end
        return
    end
    ...
    if cmd == "tactic" or cmd == "tactics" then
        if TerrorSquadAI.Modules.TerrorTactics then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo TerrorTactics no disponible")
        end
        return
    end
    ...
    if cmd == "boss" or cmd == "timer" then
        if TerrorSquadAI.Modules.BossTimerLite then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo BossTimerLite no disponible")
        end
        return
    end
    ...
    if cmd == "health" then
        if TerrorSquadAI.Modules.CriticalHealthMonitor then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo CriticalHealthMonitor no disponible")
        end
        return
    end
    ...
    if cmd == "autotarget" or cmd == "death" then
        if TerrorSquadAI.Modules.DeathWatcher then
            ...
            TerrorSquadAI:Print("|cFFFF0000Error:|r M\195\179dulo DeathWatcher no disponible")
        end
        return
    end
